...
def getIntermediateheter3classFusionDataset(cls):
    ...
    class Intermediateheter3ClassFusionDataset(cls):
        ...
        def get_item_single_car(self, selected_cav_base, ego_cav_base):
            ...
            if sensor_type == "camera":
                ...
                for idx, img in enumerate(camera_data_list):
                    idx += 1 if "V2XReal" in self.root_dir else 0
        ...
        def __getitem__(self, idx):
            ...
            # GenComm stage 2 can train only the partner message extractor.
            # If every kept agent maps to ego_modality, the whole forward path
            # is frozen and the loss has no grad_fn, which breaks backward().
            if (
                self.train
            ...
            for _i, cav_id in enumerate(cav_id_list):
                ...
                if "V2XReal" not in self.root_dir:
