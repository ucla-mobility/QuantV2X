...
# Heter 3class functionality added by Aiden Wong <aidenwong@ucla.edu>
...
def getEarlyheter3classFusionDataset(cls):
    class Earlyheter3classFusionDataset(cls):
        """
        ...
        def __getitem__(self, idx):
            ...
            classes = object_bbx_center_valid[:, 7:8]
            geom = object_bbx_center_valid[:, :7]
            geom, range_mask = \
                box_utils.mask_boxes_outside_range_numpy(geom,
                                                        self.params['preprocess'][
                                                            'cav_lidar_range'],
            ...
            object_bbx_center_valid = np.concatenate([geom, classes], axis=1)
            ...
            anchor_box = self.all_anchors_torch
    ...
    return Earlyheter3classFusionDataset
