# -*- coding: utf-8 -*-
# Author: Yifan Liu <yifan_lu@sjtu.edu.cn>
# 3class functionality added by Aiden Wong <aidenwong@ucla.edu>
...
def getLateheter3classFusionDataset(cls):
    """
    cls: the Basedataset.
    """
    class Lateheter3classFusionDataset(cls):
        def __init__(self, params, visualize, train=True, calibrate=False):
            ...
            self.all_anchors_torch = torch.from_numpy(np.array(self.all_anchors)).float()
        ...
        def get_item_single_car(self, selected_cav_base):
            ...
            object_bbx_center, object_bbx_mask, object_ids = \
                self.post_processor.generate_object_center([selected_cav_base], selected_cav_base["params"]["lidar_pose_clean"])
            ...
            selected_cav_processed.update({
                ...
                "all_anchors": self.all_anchors_torch,
                "num_anchors_per_location": self.num_anchors_per_location,
            })
        ...
        def collate_batch_train(self, batch):
            ...
            output_dict['ego'].update({'object_bbx_center': object_bbx_center,
                                    'object_bbx_mask': object_bbx_mask,
                                    'all_anchors': self.all_anchors_torch,
                                    'num_anchors_per_location': list(self.num_anchors_per_location),
        ...
        def collate_batch_test(self, batch):
            ...
            for cav_id, cav_content in batch.items():
                ...
                all_anchors_tensor = cav_content['all_anchors']
                if not torch.is_tensor(all_anchors_tensor):
                    all_anchors_tensor = torch.from_numpy(np.array(all_anchors_tensor)).float()

                output_dict[cav_id].update(
                    {
                        "anchor_box": self.all_anchors,
                        "all_anchors": all_anchors_tensor,
    ...
    return Lateheter3classFusionDataset
