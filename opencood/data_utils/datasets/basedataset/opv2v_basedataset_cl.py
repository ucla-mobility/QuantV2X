...
# Basedataset for OPV2V contrastive learning stage2.
...
class OPV2VBaseDatasetCL(Dataset):
            ...
            for (j, cav_id) in enumerate(cav_list):
                ...
                for timestamp in timestamps:
                    ...
                    self.scenario_database[i][cav_id][timestamp]['yaml'] = \
                        yaml_file
                    self.scenario_database[i][cav_id][timestamp]['lidar']['64'] = \
                        lidar_file
                    self.scenario_database[i][cav_id][timestamp]['lidar']['32'] = \
                        lidar_file.replace("OPV2V", "OPV2V_Hetero").replace(".pcd", "_32.pcd")
                    self.scenario_database[i][cav_id][timestamp]['lidar']['16'] = \
                        lidar_file.replace("OPV2V", "OPV2V_Hetero").replace(".pcd", "_16.pcd")
    ...
    def retrieve_base_data(self, idx):
        ...
        for cav_id, cav_content in scenario_database.items():
            ...
            data[cav_id]['lidar_np'] = OrderedDict()
            ...
            if self.load_lidar_file or self.visualize:
                data[cav_id]['lidar_np']['64'] = \
                    pcd_utils.pcd_to_np(cav_content[timestamp_key]['lidar']['64'])
                data[cav_id]['lidar_np']['32'] = \
                    pcd_utils.pcd_to_np(cav_content[timestamp_key]['lidar']['32'])
                data[cav_id]['lidar_np']['16'] = \
                    pcd_utils.pcd_to_np(cav_content[timestamp_key]['lidar']['16'])
