...
class BasePostprocessorMultiClass(object):
    """
    ...
    def generate_gt_bbx(self, data_dict):
        ...
        for cav_id, cav_content in data_dict.items():
            ...
            object_bbx_corner = \
                box_utils_mc.boxes_to_corners_3d(object_bbx_center,
                                              self.params['order'])
            projected_object_bbx_corner = \
                box_utils_mc.project_box3d(object_bbx_corner.float(),
        ...
        mask = \
            box_utils_mc.get_mask_for_boxes_within_range_torch(gt_box3d_tensor)
    ...
    def generate_object_center(self,
        ...
        box_utils_mc.project_world_objects(tmp_object_dict,
                                        output_dict,
                                        reference_lidar_pose,
                                        filter_range,
                                        self.params['order'])
