...
if __name__ == "__main__":
    models = [
        ...
        "opencood/logs_opv2v_quant/collab_base/pointpillar/Pyramid6432",
        "opencood/logs_opv2v_quant/collab_base/pointpillar/Pyramid3232"
    ]
    ...
    for param_name in param_names:
        ...
        plt.tight_layout()
        plt.savefig(
            f"/home/huizhi/nvme1/HEAL-alignment/opencood/logs_opv2v_quant/collab_base/pointpillar/Pyramid6432/vis_heatmap/{param_name}.png"
        )
