...
# Baseline heterogeneous collaboration with codebook learning for single-class detection.
...
class HeterBaselineCollabCodebook(HeterModelBaseline):
    def __init__(self, args):
        super(HeterBaselineCollabCodebook, self).__init__(args)
        self.channel = 256
