...
Multiclass functionality added by Aiden Wong <aidenwong@ucla.edu>
...
class HeterPyramidSingleMC(nn.Module):
    def __init__(self, args):
        super(HeterPyramidSingleMC, self).__init__()
    ...
    def forward(self, data_dict):
        ...
        if isinstance(backbone_out, dict):
            feature = backbone_out['spatial_features_2d']
        else:
