...
from .lss_recon_utils import get_encoder_out, get_encoder_input
...
def lss_reconstruction(qt_model: QuantModel, fp_model: QuantModel, qt_block: BaseQuantBlock, fp_block: BaseQuantBlock,
    ...
    for i in range(iters):
        ...
        _, out_drop = qt_block(drop_inp) # noisy input
